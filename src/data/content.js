...
const content = {
  ...
  kilasBalik: {
    ...
    foto: [
      { src: 'https://placehold.co/500x650/241A2E/E7C9A0?text=Foto+1', deskripsi: 'First Date.' },
      { src: 'https://placehold.co/500x650/241A2E/E7C9A0?text=Foto+2', deskripsi: 'Motoran Berduaaa' },
