...
const content = {
  ...
  kilasBalik: {
    ...
    foto: [
      { src: 'public/images/foto-1.HEIC', deskripsi: 'First Date.' },
      { src: 'public/images/foto-2.HEIC', deskripsi: 'Motoran Berduaaa' },
      { src: 'public/images/foto-3.HEIC', deskripsi: 'Waktu kamu ketawa sampai lupa difoto candid.' },
      { src: 'public/images/foto-4.HEIC', deskripsi: 'Liburan kecil-kecilan yang berasa besar banget.' },
      { src: 'public/images/foto-5.HEIC', deskripsi: 'Malam kita begadang cerita sampai lupa waktu.' },
      { src: 'public/images/foto-6.HEIC', deskripsi: 'Waktu kamu masakin mas walau agak gosong.' },
      { src: 'public/images/foto-7.HEIC', deskripsi: 'Perayaan kecil yang jadi kenangan besar.' },
      { src: 'public/images/foto-8.HEIC', deskripsi: 'Hari biasa yang jadi istimewa karena ada kamu.' },
      { src: 'public/images/foto-9.HEIC', deskripsi: 'Dan masih banyak lagi cerita yang akan kita tulis.' },
    ],
