...
const content = {
  ...
  kilasBalik: {
    ...
    foto: [
      { src: '/images/foto-1.jpg', deskripsi: 'First Date.' },
      { src: '/images/foto-2.jpg', deskripsi: 'Motoran Berduaaa' },
      { src: '/images/foto-3.jpg', deskripsi: 'Waktu kamu ketawa sampai lupa difoto candid.' },
      { src: '/images/foto-4.jpg', deskripsi: 'Liburan kecil-kecilan yang berasa besar banget.' },
      { src: '/images/foto-5.jpg', deskripsi: 'Malam kita begadang cerita sampai lupa waktu.' },
      { src: '/images/foto-6.jpg', deskripsi: 'Waktu kamu masakin mas walau agak gosong.' },
      { src: '/images/foto-7.jpg', deskripsi: 'Perayaan kecil yang jadi kenangan besar.' },
      { src: '/images/foto-8.jpg', deskripsi: 'Hari biasa yang jadi istimewa karena ada kamu.' },
      { src: '/images/foto-9.jpg', deskripsi: 'Dan masih banyak lagi cerita yang akan kita tulis.' },
    ],
